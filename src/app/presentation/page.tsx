    ...
    return (
        <div className="absolute left-1/2 z-0 mt-28 w-11/12 -translate-x-1/2">
            <div className="mx-auto flex h-3/6 max-w-6xl flex-col items-center lg:flex-row ">
                ...
                <div className="textP flex w-10/12 flex-col items-center justify-center text-justify xl:w-6/12">
                    <div className="flex h-3/5 w-10/12 flex-col justify-between ">
                        <p>
                            Bonjour je m&apos;appelle <a href="https://www.linkedin.com/in/baptiste-grimaldi-developpeur-web/" target='_blank'><span className="text-cyan">Baptiste Grimaldi</span></a>, je suis un développeur web <span className="text-red-600">Front-End</span> <span className="text-red-600">autodidacte</span> avec de solides connaissances en Back-End.
                        </p>
                        <br />
                        <p>
                            Je souhaite collaborer avec des <span className="font-semibold">start-ups</span> , des <span className="font-semibold">TPE</span> ou des <span className="font-semibold">PME</span> car j&apos;apprécie beaucoup la culture entrepreneuriale, qui offre un terrain propice à une
                            prise de responsabilités et à l&apos;autonomie.
                        </p>
                        <br />
                        <p>Hormis cela, j&apos;aime beaucoup l&apos;économie et les marchés financiers. Coté  jeu vidéo j&lsquo;aprécie Civilization 6, et le jeu de cartes Magic: The Gathering.</p>
                    </div>
            ...
            <div className="absolute left-1/2 h-[326px] w-10/12 max-w-5xl -translate-x-1/2">
                <Image src={'/assetPresentation/flecheDroiteBlanche.webp'} alt="Fleche Droite blanche" width={70} height={70} className="absolute right-0 top-1/2 -translate-y-1/2 cursor-pointer max-[320px]:scale-75" onClick={suivant} />
                <Image src={'/assetPresentation/flecheDroiteBlanche.webp'} alt="Fleche Gauche blanche" width={70} height={70} className="absolute left-0 top-[50.5%] -translate-y-1/2 rotate-180 cursor-pointer max-[320px]:scale-75" onClick={precedent} />
                {temoignage}
            </div>
